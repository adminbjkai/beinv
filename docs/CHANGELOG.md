...
- **HD on by default** for Trendyol Süper Lig and Premier League. Toggle still turns it off (beIN cut). Goal clips stay on beIN. Native HD/La Liga playback goes through `https://beinv.bjk.ai/video/…`.
...
- **İspanya La Liga 2025/2026** (beIN season `3850`, slug `laliga-easports-2025`) overlay alongside 2026/2027. Native **source** loads La Liga weeks from the remux host instead of empty beIN events.
- **Native binaries not rebuilt** in this commit (no Android SDK / Xcode on the machine that landed v2.7). Resume: [NATIVE_RESUME.md](NATIVE_RESUME.md).

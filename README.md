...
Highlights (özetler) for **Trendyol Süper Lig**, **İngiltere Premier Lig** and **İspanya La Liga**, with league / season / week selection and video playback. Süper Lig and Premier League come from beinsports.com.tr's public endpoints (no auth). La Liga 2026/2027 uses the same seasons/weeks table, with official match highlights remuxed by the web server into a same-origin MP4 — see [docs/UPSTREAM_API.md](docs/UPSTREAM_API.md).

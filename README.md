...
- Browse: league segmented buttons, a season dropdown and a week dropdown with ‹ › steppers, 2-column card grid (3 on wide screens). Tap a card → player with a clip list (full highlight + goals/positions).

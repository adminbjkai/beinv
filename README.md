...
| dir | what | run |
|---|---|---|
| [`tv/`](tv/) | **Apple TV app** (SwiftUI + AVKit). Catalog from beIN; HD + La Liga play from `beinv.bjk.ai`. v2.7.1 on Living Room Apple TV. | [NATIVE_RESUME.md](docs/NATIVE_RESUME.md) |
| [`android/`](android/) | **Android app** (Kotlin, Compose, Media3 ExoPlayer). Same split. v2.7.1 debug APK built and launched on Pixel_9. | [android/README.md](android/README.md) · [NATIVE_RESUME.md](docs/NATIVE_RESUME.md) |
...
v2.7.1 is installed on the Living Room Apple TV 4K. Simulator build notes and device checklist: [docs/NATIVE_RESUME.md](docs/NATIVE_RESUME.md).
